...
export default function LoginPage({ onLogin, isSignupDefaultMode = false }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-6 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-5">
            ...
            {/* Success Alert */}
            {success && (
              <div className="p-4 bg-green-50 border-l-4 border-green-500 rounded flex items-start gap-3">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition pr-10"
            ...
            {isSignup && (
              <div>
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition bg-white text-black"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full px-4 py-3 bg-gradient-to-r from-black to-gray-900 hover:from-gray-900 hover:to-black disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold rounded-lg transition-all transform hover:scale-105 active:scale-95"
            >
              {loading
            ...
            <div className="mt-6 relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-white text-gray-700 font-medium">Or</span>
              </div>
            </div>
            ...
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-3 border-2 border-gray-300 hover:border-black text-gray-700 font-semibold rounded-lg transition-all flex items-center justify-center gap-2 hover:bg-gray-50"
            >
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-200">
            ...
            <button
              ...
              className="w-full px-4 py-2 border-2 border-black text-black font-semibold rounded-lg hover:bg-gray-100 transition"
            >
        ...
        {/* Support Text */}
        <div className="text-center text-gray-600 text-xs mt-6 flex items-center justify-center gap-2">
